# Text Adventure Inspired Number Guesser

This is a small project I made to learn C++ using the project architecture template provided by TheCherno.  The game is at heart a number guessing game with a story aspect to it. There are two included projects - one called _Core_, and one called _App_. [Premake](https://github.com/premake/premake-core) is used to generate project files.
